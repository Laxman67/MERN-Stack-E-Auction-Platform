      ...
      <section className='w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center'>
        ...
        <div>
          ...
          <ul className='list-inside'>
            {values.map((element) => {
              return (
                <li key={element.id} className='text-xl text-stone-600 mb-2'>
                  <span className='font-bold text-black'>{element.title}</span>:{' '}
                  {element.description}
                </li>
              );
            })}
        ...
        <div>
          ...
          <p className='text-xl text-stone-600'>
            PrimeBid was born out of a passion for connecting people with unique
