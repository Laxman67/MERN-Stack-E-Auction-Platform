    ...
    <>
      <section className='my-8 lg:px-5'>
        ...
        <div className='overflow-x-auto'>
          <table className='min-w-full bg-white  my-5  border border-y-gray-300'>
            <thead>
              <tr>
        ...
        <Link
          to='/leaderbaord'
          className='border-2 border-stone-200 font-bold text-xl w-full py-2 flex justify-center rounded-md hover:border-stone-500  transition-all duration-500'
        >
          Go to Leaderboard
        </Link>
      </section>
